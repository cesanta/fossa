...
static void op_get(struct ns_connection *nc, const struct http_message *hm,
                   const struct ns_str *key, void *db) {
  sqlite3_stmt *stmt = NULL;
...
static void op_del(struct ns_connection *nc, const struct http_message *hm,
                   const struct ns_str *key, void *db) {
  sqlite3_stmt *stmt = NULL;
  int result;
  (void) hm;
...
void db_op(struct ns_connection *nc, const struct http_message *hm,
           const struct ns_str *key, void *db, int op) {
  switch (op) {
