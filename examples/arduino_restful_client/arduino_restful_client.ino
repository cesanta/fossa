...
// DEVICES WITH THE SAME IP OR MAC ADDRESS
// SHOULD NOT BE IN ONE NETWORK

// USE MAC ADDRESS FROM STICKER (IF AVAILAVBLE) 
// READ ABOUT MAC ADDRESS HERE: http://en.wikipedia.org/wiki/MAC_address
