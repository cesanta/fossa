...
(function($opal) {
  ...
  return (function($base) {
    ...
    def.$add_observer = function(observer, func) {
      ...
      if (($a = (($b = self['observer_peers'], $b != null && $b !== nil) ? 'instance-variable' : nil)) === false || $a === nil) {
    ...
    def['$changed?'] = function() {
      ...
      if (($a = ($b = (($c = self['observer_state'], $c != null && $c !== nil) ? 'instance-variable' : nil), $b !== false && $b !== nil ?self.observer_state : $b)) !== false && $a !== nil) {
        return true
        } else {
        return false
      };
    ...
    def.$notify_observers = function(arg) {
      ...
      if (($a = ($b = (($c = self['observer_state'], $c != null && $c !== nil) ? 'instance-variable' : nil), $b !== false && $b !== nil ?self.observer_state : $b)) !== false && $a !== nil) {
        if (($a = (($b = self['observer_peers'], $b != null && $b !== nil) ? 'instance-variable' : nil)) !== false && $a !== nil) {
          ($a = ($b = self.observer_peers).$each, $a._p = (TMP_1 = function(k, v){var self = TMP_1._s || this, $a;if (k == null) k = nil;if (v == null) v = nil;
