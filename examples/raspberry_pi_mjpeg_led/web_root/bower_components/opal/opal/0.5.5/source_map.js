...
(function($opal) {
  ...
  return (function($base, $super) {
    ...
    var def = $SourceMap._proto, $scope = $SourceMap._scope;
    return (function($base) {
      ...
      $opal.cdecl($scope, 'BASE64_VALUES', ($a = ($b = ($range(0, 64, false))).$inject, $a._p = (TMP_1 = function(h, i){var self = TMP_1._s || this;if (h == null) h = nil;if (i == null) i = nil;
      ...
      $opal.defs(self, '$decode_array', function(str) {
        var $a, $b, $c, self = this, output = nil, int = nil;
        output = [];
        while (($b = ($c = str['$=='](""), ($c === nil || $c === false))) !== false && $b !== nil) {
  ...
  return (function($base, $super) {
    ...
    return (function($base) {
      ...
      def.$add_generated = function(text, opts) {
        ...
        if (($a = ($b = ($c = opts['$[]']("source"), ($c === nil || $c === false)), $b !== false && $b !== nil ?(((($c = ((($d = opts['$[]']("name")) !== false && $d !== nil) ? $d : opts['$[]']("source_line"))) !== false && $c !== nil) ? $c : opts['$[]']("source_col"))) : $b)) !== false && $a !== nil) {
          self.$raise("mapping must have :source to have :source_line, :source_col or :name")
        } else if (($a = ($b = opts['$[]']("source_line"), $b !== false && $b !== nil ?opts['$[]']("source_line")['$<'](1) : $b)) !== false && $a !== nil) {
          self.$raise("files start on line 1 (got :source_line => " + (opts['$[]']("source_line")) + ")")
        } else if (($a = ($b = ((remain = opts.$keys()['$-'](["source", "source_line", "source_col", "name", "exact_position"])))['$empty?'](), ($b === nil || $b === false))) !== false && $a !== nil) {
      ...
      def.$add_mapping = function(map) {
        var $a, $b, $c, $d, self = this, remain = nil;
        if (($a = ((($b = ($c = map['$[]']("generated_line"), ($c === nil || $c === false))) !== false && $b !== nil) ? $b : ($c = map['$[]']("generated_col"), ($c === nil || $c === false)))) !== false && $a !== nil) {
          self.$raise("mapping must have :generated_line and :generated_col")
        } else if (($a = ($b = map['$[]']("source"), $b !== false && $b !== nil ?($c = (($d = map['$[]']("source_line"), $d !== false && $d !== nil ?map['$[]']("source_col") : $d)), ($c === nil || $c === false)) : $b)) !== false && $a !== nil) {
          self.$raise("mapping must have :source_line and :source_col if it has :source")
        } else if (($a = ($b = ($c = map['$[]']("source"), ($c === nil || $c === false)), $b !== false && $b !== nil ?(((($c = map['$[]']("source_line")) !== false && $c !== nil) ? $c : map['$[]']("source_col"))) : $b)) !== false && $a !== nil) {
          self.$raise("mapping may not have a :source_line or :source_col without a :source")
        } else if (($a = ($b = map['$[]']("name"), $b !== false && $b !== nil ?($c = map['$[]']("source"), ($c === nil || $c === false)) : $b)) !== false && $a !== nil) {
          self.$raise("mapping may not have a :name without a :source")
        } else if (($a = ($b = map['$[]']("source_line"), $b !== false && $b !== nil ?map['$[]']("source_line")['$<'](1) : $b)) !== false && $a !== nil) {
        ...
        } else if (($a = ($b = ((remain = map.$keys()['$-'](["generated_line", "generated_col", "source", "source_line", "source_col", "name"])))['$empty?'](), ($b === nil || $b === false))) !== false && $a !== nil) {
          self.$raise("mapping had unexpected keys: " + (remain.$inspect()))};
      ...
      def.$save = function(file) {
        ...
        return ($a = ($b = $scope.File).$open, $a._p = (TMP_2 = function(f){var self = TMP_2._s || this;if (f == null) f = nil;
      ...
      def.$source_id = function(file) {
        ...
        if (($a = (cached = self.$source_ids()['$[]'](file))) !== false && $a !== nil) {
          return cached
          } else {
          self.$sources()['$<<'](file);
      ...
      def.$name_id = function(name) {
        var $a, self = this, cached = nil;
        if (($a = (cached = self.$name_ids()['$[]'](self.$file()))) !== false && $a !== nil) {
          return cached
          } else {
          self.$names()['$<<'](name);
      ...
      def['$serialize_mappings!'] = function() {
        ...
        if (($a = self.$mappings()['$empty?']()) !== false && $a !== nil) {
          return ""};
        by_lines = ($a = ($c = self.$mappings()).$group_by, $a._p = (TMP_4 = function(x){var self = TMP_4._s || this;if (x == null) x = nil;
...
if (line == null) line = nil;
        self.previous_vlq['$[]=']("generated_col", 0);
          fragments = ($a = ($b = (((($c = by_lines['$[]'](line)) !== false && $c !== nil) ? $c : []))).$sort_by, $a._p = (TMP_6 = function(x){var self = TMP_6._s || this;if (x == null) x = nil;
          return x['$[]']("generated_col")}, TMP_6._s = self, TMP_6), $a).call($b);
          return ($a = ($c = fragments).$map, $a._p = (TMP_7 = function(map){var self = TMP_7._s || this;if (map == null) map = nil;
...
if (line == null) line = nil;if (line_idx == null) line_idx = nil;
        self.previous['$[]=']("generated_col", 0);
          return ($a = ($b = line.$split(",")).$each, $a._p = (TMP_3 = function(segment){var self = TMP_3._s || this;if (segment == null) segment = nil;
          return self.$mappings()['$<<'](self.$parse_mapping(segment, line_idx['$+'](1)))}, TMP_3._s = self, TMP_3), $a).call($b);}, TMP_2._s = self, TMP_2), $a).call($c);
        return self['$mappings='](($a = ($d = self.$mappings()).$sort_by, $a._p = (TMP_4 = function(x){var self = TMP_4._s || this;if (x == null) x = nil;
      ...
      def.$parse_mapping = function(segment, line_num) {
        ...
        if (($a = [1, 4, 5]['$include?'](item.$size())) === false || $a === nil) {
        ...
        } else if (($a = ($b = map['$key?']("source"), $b !== false && $b !== nil ?(((($c = map['$[]']("source")['$nil?']()) !== false && $c !== nil) ? $c : self.previous['$[]']("source_id")['$<'](0))) : $b)) !== false && $a !== nil) {
          return self.$raise($scope.ParserError, "In map for " + (self.$file()) + ":" + (line_num) + ": unknown source id: " + (self.previous['$[]']("source_id")))
        } else if (($a = ($b = map['$key?']("source_line"), $b !== false && $b !== nil ?map['$[]']("source_line")['$<'](1) : $b)) !== false && $a !== nil) {
          return self.$raise($scope.ParserError, "In map for " + (self.$file()) + ":" + (line_num) + ": unexpected source_line: " + (map['$[]']("source_line")))
        } else if (($a = ($b = map['$key?']("source_col"), $b !== false && $b !== nil ?map['$[]']("source_col")['$<'](0) : $b)) !== false && $a !== nil) {
          return self.$raise($scope.ParserError, "In map for " + (self.$file()) + ":" + (line_num) + ": unexpected source_col: " + (map['$[]']("source_col")))
        } else if (($a = ($b = map['$key?']("name"), $b !== false && $b !== nil ?(((($c = map['$[]']("name")['$nil?']()) !== false && $c !== nil) ? $c : self.previous['$[]']("name_id")['$<'](0))) : $b)) !== false && $a !== nil) {
...
(function($opal) {
  ...
  return (function($base, $super) {
    ...
    def.$initialize = function(opts) {
      var $a, $b, self = this, remain = nil;
      if (opts == null) {
        opts = $hash2([], {})
      }
      if (($a = ((remain = opts.$keys()['$-'](["generated_output", "file", "source_root", "sources", "names", "version"])))['$empty?']()) === false || $a === nil) {
      ...
      self['$mappings=']([]);
      if (($a = ($b = self.$version()['$=='](3), ($b === nil || $b === false))) !== false && $a !== nil) {
