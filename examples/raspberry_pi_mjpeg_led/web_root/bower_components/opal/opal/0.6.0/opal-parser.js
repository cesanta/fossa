  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$here_document = function(str_parse) {
        var $a, $b, $c, self = this, eos_regx = nil, expand = nil, str_buffer = nil, tok = nil, reg = nil, complete_str = nil;
      ...
      def.$heredoc_identifier = function() {
        var $a, self = this, heredoc = nil, end_of_line = nil;

        if ((($a = self.$scan(/(-?)['"]?(\w+)['"]?/)) !== nil && (!$a._isBoolean || $a == true))) {
          heredoc = self.scanner['$[]'](2);
          self['$strterm='](self.$new_strterm($scope.STR_DQUOTE, heredoc, heredoc));
...
if (name == null) name = nil;if (idx == null) idx = nil;
        ...
        def.$compile_to_fragments = function() {
          ...
          if ((($a = self.fragments) !== nil && (!$a._isBoolean || $a == true))) {
...
if (child == null) child = nil;if (idx == null) idx = nil;
      ...
      (function($base, $super) {
        ...
        def.$compile = function() {
          ...
          self.$push("if (");
          ($a = ($b = self.$rescue_classes()).$each_with_index, $a._p = (TMP_4 = function(cls, idx){var self = TMP_4._s || this, call = nil;
if (cls == null) cls = nil;if (idx == null) idx = nil;
          if (idx['$=='](0)) {
              } else {
              self.$push(", ")
            };
          ...
          if ((($a = self.$rescue_classes()['$empty?']()) !== nil && (!$a._isBoolean || $a == true))) {
            self.$push("true")};
          self.$push(") {");
        ...
        def.$rescue_variable = function() {
          ...
          if ((($a = ($b = $scope.Sexp['$==='](variable), $b !== false && $b !== nil ?["lasgn", "iasgn"]['$include?'](variable.$type()) : $b)) !== nil && (!$a._isBoolean || $a == true))) {
            return variable.$dup()
            } else {
            return nil
          };
        ...
        def.$rescue_classes = function() {
          var $a, $b, self = this, classes = nil;

          classes = self.$args().$children();
          if ((($a = ($b = classes.$last(), $b !== false && $b !== nil ?classes.$last().$type()['$==']("const")['$!']() : $b)) !== nil && (!$a._isBoolean || $a == true))) {
            classes.$pop()};
          return classes;
        };
...
(function($opal) {
  ...
  return (function($base) {
    ...
    $opal.cdecl($scope, 'VERSION', "0.6.0")
