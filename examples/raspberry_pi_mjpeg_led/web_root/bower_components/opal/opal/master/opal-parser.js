...
Opal.modules["opal/parser"] = function($opal) {
  ...
  $opal.add_stubs(['$require', '$attr_reader', '$new', '$parser=', '$parse_to_sexp', '$push_scope', '$do_parse', '$pop_scope', '$next_token', '$last', '$parent=', '$<<', '$pop', '$raise', '$inspect', '$value', '$token_to_str', '$line', '$lexer', '$[]', '$s', '$source=', '$s0', '$source', '$s1', '$file', '$to_sym', '$nil?', '$==', '$length', '$size', '$type', '$each', '$!', '$add_local', '$scope', '$to_s', '$empty?', '$is_a?', '$new_splat', '$new_call', '$===', '$new_gettable', '$type=', '$has_local?', '$[]=', '$>']);
