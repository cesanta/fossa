...
/* Generated by Opal 0.7.0.dev */
Opal.modules["source_map/vlq.rb"] = function($opal) {
...
/* Generated by Opal 0.7.0.dev */
Opal.modules["source_map/generator.rb"] = function($opal) {
...
/* Generated by Opal 0.7.0.dev */
Opal.modules["source_map/parser.rb"] = function($opal) {
...
Opal.modules["source_map"] = function($opal) {
  ...
  $opal.add_stubs(['$require', '$include', '$empty?', '$-', '$keys', '$raise', '$inspect', '$generated_output=', '$[]', '$file=', '$source_root=', '$version=', '$sources=', '$names=', '$mappings=', '$!', '$==', '$version', '$attr_accessor']);
  self.$require("json");
  self.$require("source_map/vlq.rb");
  self.$require("source_map/generator.rb");
  self.$require("source_map/parser.rb");
  return (function($base, $super) {
    function $SourceMap(){};
    var self = $SourceMap = $klass($base, $super, 'SourceMap', $SourceMap);
...
Opal.modules["opal/source_map"] = function($opal) {
  ...
  $opal.add_stubs(['$require', '$attr_reader', '$tap', '$each', '$line', '$add_mapping', '$column', '$file', '$count', '$code', '$+', '$>', '$-', '$size', '$rindex', '$new', '$as_json', '$map', '$to_s']);
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$map = function() {
        var $a, $b, $c, TMP_1, $d, self = this;

        return ((($a = self.map) !== false && $a !== nil) ? $a : self.map = ($b = ($c = (($d = $opal.Object._scope.SourceMap) == null ? $opal.cm('SourceMap') : $d).$new()).$tap, $b._p = (TMP_1 = function(map){var self = TMP_1._s || this, $a, $b, TMP_2, line = nil, column = nil;
          if (self.fragments == null) self.fragments = nil;
if (map == null) map = nil;
        $a = [1, 0], line = $a[0], column = $a[1];
          return ($a = ($b = self.fragments).$each, $a._p = (TMP_2 = function(fragment){var self = TMP_2._s || this, $a, source_line = nil, new_lines = nil;
if (fragment == null) fragment = nil;
          if ((($a = source_line = fragment.$line()) !== nil && (!$a._isBoolean || $a == true))) {
              map.$add_mapping($hash2(["generated_line", "generated_col", "source_line", "source_col", "source"], {"generated_line": line, "generated_col": column, "source_line": source_line, "source_col": fragment.$column(), "source": self.$file()}))};
            new_lines = fragment.$code().$count("\n");
            line = line['$+'](new_lines);
            if (new_lines['$>'](0)) {
              return column = fragment.$code().$size()['$-']((fragment.$code().$rindex("\n")['$+'](1)))
              } else {
              return column = column['$+'](fragment.$code().$size())
            };}, TMP_2._s = self, TMP_2), $a).call($b);}, TMP_1._s = self, TMP_1), $b).call($c));
      };
...
//# sourceMappingURL=/__opal_source_maps__/opal-source-maps.js.map
;
